...
export default function ErrorCard({ state, error, onClose }: Props) {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[2147483646] bg-[#0A0A0A]/95 backdrop-blur-xl text-white rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] min-w-[240px] max-w-[340px] font-sans text-[13px] border border-[#ffffff1a] pointer-events-auto">
